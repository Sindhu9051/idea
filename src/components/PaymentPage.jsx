    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-100 to-indigo-100 flex items-center justify-center p-5 relative">
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-6">
        ...
        >
          ...
          <div className="mt-8">
            <div className="bg-white text-indigo-600 text-2xl font-bold p-5 rounded-xl text-center shadow-md">
              Total: ₹ {course.price}
            </div>
            <p className="text-xs mt-2 text-center text-indigo-200">
              *All taxes included
            </p>
          </div>
        </div>
        ...
        {/* Right */}
        <div className="md:w-1/2 bg-white p-10 rounded-3xl shadow-2xl flex flex-col justify-center">
          {!paymentSuccess ? (
            <>
            ...
            <div className="text-center p-10 bg-green-50 rounded-xl shadow-lg">
              ...
              <p className="text-gray-700 mb-6">
                ...
                <br />
                Your payment for{" "}
                <span className="font-semibold">{course.name}</span> has been
                completed.
              </p>
              <button
                onClick={() => navigate("/")}
                className="bg-indigo-500 hover:bg-purple-500 text-white font-bold py-3 px-8 rounded-xl"
              >
                Go to Home
              </button>
            </div>
